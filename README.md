# FinSight - Finance Augmentée 🚀# FinSight - Dashboard Finance Interactif# FinSight - Dashboard Finance Interactif



**Démonstrateur technique pour DAF/CFO - Niveau WOW 85/100**



> Plateforme d'analyse financière augmentée par IA pour PME/ETI françaises> **Démonstrateur technique pour missions de consulting Data Analytics Finance**> **Démonstrateur technique pour missions de consulting Data Analytics Finance**
...
✅ **Version Polish v85/100** - Prêt pour démonstrations DAF  FinSight est un **produit d'appel** qui démontre mes capacités en développement de solutions financières sur-mesure pour PME/ETI françaises.FinSight est un **produit d'appel** qui démontre mes capacités en développement de solutions financières sur-mesure pour PME/ETI françaises.

✅ **Export PDF** - Dashboard complet exportable

✅ **Sélecteur de période** - 3M/6M/12M/YTD fonctionnel

✅ **Page Méthodologie** - Tarification et process documentés

✅ **AI Copilot** - 8 types de réponses financières contextuelles  ## 🎯 **L'Approche**## 🎯 **L'Approche**
...
- **Frontend**: Next.js 14 + TypeScript + Tailwind CSSFinSight n'est pas une SaaS, mais un **outil de démonstration** qui dit :FinSight n'est pas une SaaS, mais un **outil de démonstration** qui dit :

- **Charts**: Recharts avec tooltips financiers

- **Export**: jsPDF + html2canvas> *"Voilà ce que je peux vous livrer en 2-3 jours"*> *"Voilà ce que je peux vous livrer en 2-3 jours"*

- **Déploiement**: Prêt Vercel/Netlify



## 🚀 Démarrage

Cette démo technique ouvre ensuite des discussions sur :Cette démo technique ouvre ensuite des discussions sur :

```bash

npm install- **Dashboards sur-mesure** (2-3K€)- **Dashboards sur-mesure** (2-3K€)
