...
const faqJsonLd = {
    ...
    mainEntity: [
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'FinSight est un outil de pré-diagnostic qui vous donne une vision instantanée et structurée de votre santé financière. Il identifie les signaux d\'alerte et priorise les actions. Pour un accompagnement complet en pilotage financier, FinSight propose ensuite un Audit Stratégique à 2 490€ HT.',
            },
        },
    ],
}
