        ...
        <div className="min-h-screen bg-primary text-primary font-sans">
            ...
            <header className="border-b border-border-subtle backdrop-blur-sm bg-primary/80 sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        ...
                        <Link href="/services" className="text-accent-primary font-medium text-sm">
                            Nos Offres
                        </Link>
                        <a
            ...
            <section className="relative max-w-5xl mx-auto px-6 pt-24 pb-20 text-center">
                ...
                <div className="relative z-10">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-accent-primary-subtle border border-accent-primary-border rounded-full mb-8">
                        ...
                        <span className="text-accent-primary text-sm font-medium">Produit Clé en Main • Personnalisable</span>
                    </div>

                    <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight leading-tight">
                        FinSight pour<br />
                        <span className="text-accent-primary">Votre Entreprise</span>
                    </h1>
            ...
            <section className="max-w-7xl mx-auto px-6 pb-32">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {/* Package 1: Express */}
                    <div className="surface rounded-2xl p-8 border border-border-subtle hover:border-accent-primary-border transition-all">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-tertiary text-sm">Démarrage rapide</p>
                            </div>
                        </div>

                        <div className="mb-6">
                            <div className="flex items-baseline gap-2 mb-2">
                                <span className="text-5xl font-bold text-accent-primary">2 500€</span>
                            </div>
                            <p className="text-secondary text-sm">Livraison en 1 semaine</p>
                        </div>

                        <ul className="space-y-3 mb-8">
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">Déploiement FinSight standard</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">Import de vos données comptables</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">Configuration 15 KPIs de base</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">1 session formation (2h)</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">Export PDF/Excel</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">Documentation technique</span>
                            </li>
                        </ul>
                    ...
                    <div className="surface rounded-2xl p-8 border-2 border-accent-primary relative overflow-hidden">
                        ...
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-tertiary text-sm">Solution complète</p>
                            </div>
                        </div>

                        <div className="mb-6">
                            <div className="flex items-baseline gap-2 mb-2">
                                <span className="text-5xl font-bold text-accent-primary">4 500€</span>
                            </div>
                            <p className="text-secondary text-sm">Livraison en 2 semaines</p>
                        </div>

                        <ul className="space-y-3 mb-8">
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary font-semibold">Tout du package Express +</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">Design aux couleurs de votre marque</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">KPIs personnalisés selon votre secteur</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">AI Copilot configuré (questions métier)</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">Alertes email automatiques</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">2 sessions formation (CFO + équipe)</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">1 mois support inclus</span>
                            </li>
                        </ul>
                    ...
                    <div className="surface rounded-2xl p-8 border border-border-subtle hover:border-accent-primary-border transition-all">
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-secondary text-sm">À partir de 8 000€</p>
                        </div>

                        <ul className="space-y-3 mb-8">
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary font-semibold">Tout du package Pro +</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">Connexion à votre ERP (Sage, Cegid, SAP)</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">Multi-entités (filiales, BU)</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">Workflows personnalisés</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">Dashboard C-level + Board</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">Formation étendue (3 sessions)</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">3 mois support inclus</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-accent-primary flex-shrink-0 mt-0.5" />
                                <span className="text-sm text-secondary">Code source remis</span>
                            </li>
                        </ul>
            ...
            <section className="max-w-5xl mx-auto px-6 pb-24">
                <div className="surface rounded-2xl p-12 border border-accent-primary-border">
                    <div className="text-center mb-10">
                        <h2 className="text-3xl font-bold mb-3">🎁 Inclus dans toutes les offres</h2>
                        <p className="text-secondary">Ce que vous recevez, quel que soit le package</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="flex items-start gap-4">
                            <div className="w-12 h-12 rounded-xl bg-accent-primary-subtle border border-accent-primary-border flex items-center justify-center flex-shrink-0">
                                <Code className="w-6 h-6 text-accent-primary" />
                            </div>
                            <div>
                                <h3 className="font-semibold mb-1">Code source personnalisé</h3>
                                <p className="text-sm text-secondary">Vous êtes propriétaire à 100%. Modifiez comme vous voulez.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-secondary">Sur Vercel ou votre propre serveur. Configuration complète.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-secondary">Guide d'installation, architecture, et maintenance.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-secondary">Aucun abonnement. Payez une fois, gardez à vie.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="max-w-5xl mx-auto px-6 pb-24">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-secondary">Un processus simple en 4 étapes</p>
                </div>
            ...
            <section className="max-w-4xl mx-auto px-6 pb-24">
                ...
                <div className="space-y-6">
                    <div className="surface rounded-xl p-6 border border-border-subtle">
                        ...
                        <p className="text-sm text-secondary pl-5">
                    ...
                    <div className="surface rounded-xl p-6 border border-border-subtle">
                        ...
                        <p className="text-sm text-secondary pl-5">
                            Vous pouvez tester gratuitement sur <Link href="/dashboard" className="text-accent-primary hover:underline">la démo live</Link> avec vos propres données CSV. Pour une démo personnalisée avec vos vrais exports comptables, prenez RDV (gratuit).
                        </p>
                    </div>
                </div>
            </section>
