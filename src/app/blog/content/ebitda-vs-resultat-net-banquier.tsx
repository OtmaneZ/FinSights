...
<div className="published-article-body space-y-6">
    ...
    <section className="mb-12">
        <h2 className="text-3xl font-bold text-white mb-6">Le résultat net : une photo retouchée</h2>
    ...
    {/* Section 2 */}
    <section className="mb-12">
        <h2 className="text-3xl font-bold text-white mb-6">L'EBITDA : le moteur nu</h2>
    ...
    {/* Section 3 */}
    <section className="mb-12">
        <h2 className="text-3xl font-bold text-white mb-6">Pourquoi le banquier s'arrête là</h2>
        ...
        <div className="not-prose bg-slate-800 rounded-xl p-6 border-2 border-blue-400 mb-6 text-center">
            <p className="text-xl font-bold text-blue-300">Dette nette / EBITDA</p>
        </div>
    ...
    {/* Section 4 */}
    <section className="mb-12">
        <h2 className="text-3xl font-bold text-white mb-6">Ce que vous devez retenir</h2>
