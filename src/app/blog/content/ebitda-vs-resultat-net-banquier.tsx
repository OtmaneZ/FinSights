...
<div className="published-article-body">
    ...
    <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-12">
            <h2 className="text-3xl font-bold text-primary mb-6">Le résultat net : une photo retouchée</h2>
        ...
        {/* Section 2 */}
        <section className="mb-12">
            <h2 className="text-3xl font-bold text-primary mb-6">L'EBITDA : le moteur nu</h2>
            ...
            <p className="text-secondary leading-relaxed mb-6">La formule :</p>

            <div className="surface rounded-xl p-6 border border-accent-primary/30 mb-6 text-center">
        ...
        {/* Section 3 */}
        <section className="mb-12">
            <h2 className="text-3xl font-bold text-primary mb-6">Pourquoi le banquier s'arrête là</h2>
            ...
            <div className="surface rounded-xl p-6 border border-accent-primary/30 mb-6 text-center">
                <p className="text-xl font-bold text-primary">Dette nette / EBITDA</p>
            </div>
            ...
            <div className="surface rounded-xl p-6 border-l-4 border-yellow-500 mb-6">
        ...
        {/* Section 4 */}
        <section className="mb-12">
            <h2 className="text-3xl font-bold text-primary mb-6">Ce que vous devez retenir</h2>
        ...
        {/* CTA */}
        <div className="surface rounded-xl p-8 border border-accent-primary/30 text-center mt-12">
