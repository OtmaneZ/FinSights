...
export const metadata: Metadata = {
    ...
    description: 'Toutes les réponses à vos questions : DAF externalisé vs expert-comptable, sécurité des données, formats acceptés, tarifs, engagement. FinSight - PME 500k€-5M€.',
    keywords: [
        'faq daf externalisé',
        'questions finsight',
