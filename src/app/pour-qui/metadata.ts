...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        url: 'https://finsight.zineinsight.com/pour-qui',
        type: 'website',
        images: [
            {
                url: 'https://finsight.zineinsight.com/images/og-pour-qui.png',
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        images: ['https://finsight.zineinsight.com/images/og-pour-qui.png']
    },
    alternates: {
        canonical: 'https://finsight.zineinsight.com/pour-qui'
    }
}
