        ...
        <section className="max-w-7xl mx-auto px-6 py-20">
                ...
                {testimonials.map((testimonial, index) => (
                    ...
                    >
                        <div className="flex items-start gap-3 mb-4">
                            <Quote className="w-8 h-8 text-accent-gold flex-shrink-0" />
                        ...
                        <div className="border-t border-border-subtle pt-4">
                            ...
                            <p className="text-text-tertiary text-xs mt-1">{testimonial.company}</p>
                        </div>
                    </div>
                ))}
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 pt-16 border-t border-border-subtle">
                <div className="text-center">
                    <div className="text-4xl font-bold text-accent-gold mb-2">200+</div>
                    <div className="text-text-secondary text-sm">Utilisateurs actifs</div>
                </div>
                <div className="text-center">
                    <div className="text-4xl font-bold text-accent-gold mb-2">3h</div>
                    <div className="text-text-secondary text-sm">Gagnées/semaine</div>
                </div>
                <div className="text-center">
                    <div className="text-4xl font-bold text-accent-gold mb-2">15+</div>
                    <div className="text-text-secondary text-sm">KPIs calculés</div>
                </div>
                <div className="text-center">
