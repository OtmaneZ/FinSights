...
const CashFlowChart = dynamic(() => import('./charts/CashFlowChart'), {
    ssr: false,
    loading: () => <div style={{ width: '100%', height: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}> Chargement...</div>
});
            ...
            <header className="finsight-header">
                <div className="finsight-nav-container">
                    <div className="finsight-brand-container">
                        ...
                        <span className="finsight-brand-subtitle">Dashboard Finance</span>
                    </div>
                    <nav className="finsight-nav-menu">
                        <a href="/" className="finsight-nav-link">Accueil</a>
                        <a href="/dashboard" className="finsight-nav-link active">Dashboard</a>
            ...
            <div className="finsight-main">
                <div className="mb-8">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                        <div>
                            <h1 className="finsight-section-title">Dashboard Financier</h1>
                            <p className="finsight-section-subtitle">{isDataLoaded && finSightData ? finSightData.period.label : getPeriodData(selectedPeriod).title}</p>
                        </div>
                    ...
                    {/* Zone d'upload */}
                    {showUploadZone && (
                        <div className="finsight-upload-zone mt-6">
